    ...
    .. note::
        ...
        ::
            ...
            annotations/
                ...
                ...
    """
    def __init__(self, root='/data/AmitRoyChowdhury/Humans3.6M/data/', split='train', task='all', download=True, k=1, 
    ...
    def preprocess(self, part, root):
        ...
        for i, image_data in enumerate(tqdm.tqdm(images)):
            ...
            if i % 5 == 0:
                ...
                src_image_path = os.path.join(root, "images_folder", image_data['file_name'])
