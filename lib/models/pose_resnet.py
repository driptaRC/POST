...
#
#
# def trans_pose_resnet50(num_keypoints, pretrained_backbone=True, deconv_with_bias=False, finetune=False, progress=True, **kwargs):
#     """Constructs a Simple Baseline model with a ResNet-101 backbone.
#
#     Args:
#         num_keypoints (int): number of keypoints
...
#
#
# def trans_pose_resnet50_layer4(num_keypoints, pretrained_backbone=True, deconv_with_bias=False, finetune=False, progress=True, **kwargs):
#     """Constructs a Simple Baseline model with a ResNet-101 backbone.
#
#     Args:
#         num_keypoints (int): number of keypoints
...
#
#     update_config(cfg, kwargs['args'])
#     model = get_pose_net_layer4(cfg)
#     model.finetune = finetune
#     return model, cfg
#
#
# def trans_pose_resnet50_layer4_cross(num_keypoints, pretrained_backbone=True, deconv_with_bias=False, finetune=False, progress=True, **kwargs):
#     """Constructs a Simple Baseline model with a ResNet-101 backbone.
#
#     Args:
#         num_keypoints (int): number of keypoints
...
#
#     update_config(cfg, kwargs['args'])
#     model = get_pose_net_layer4_cross(cfg)
#     model.finetune = finetune
#     return model, cfg
#
#
# def trans_pose_resnet50_layer4_cross_multiple_encoders(num_keypoints, pretrained_backbone=True, deconv_with_bias=False, finetune=False, progress=True, **kwargs):
#     """Constructs a Simple Baseline model with a ResNet-101 backbone.
#
#     Args:
#         num_keypoints (int): number of keypoints
...
#
#     update_config(cfg, kwargs['args'])
#     model = get_pose_net_layer4_cross_multiple_encoders(cfg)
#     model.finetune = finetune
#     return model, cfg
#
#
#
#
# def trans_pose_resnet50_layer4_residual(num_keypoints, pretrained_backbone=True, deconv_with_bias=False, finetune=False, progress=True, **kwargs):
#     """Constructs a Simple Baseline model with a ResNet-101 backbone.
#
#     Args:
#         num_keypoints (int): number of keypoints
...
#
#     update_config(cfg, kwargs['args'])
#     model = get_pose_net_layer4_residual(cfg)
#     model.finetune = finetune
#     return model, cfg
#
#
# def trans_pose_resnet50_layer4_deconv_first(num_keypoints, pretrained_backbone=True, deconv_with_bias=False, finetune=False, progress=True, **kwargs):
#     """Constructs a Simple Baseline model with a ResNet-101 backbone.
#
#     Args:
#         num_keypoints (int): number of keypoints
...
#
#     update_config(cfg, kwargs['args'])
#     model = get_pose_net_layer4_deconv_first(cfg)
#     model.finetune = finetune
#     return model, cfg
#
#
#
# def trans_pose_resnet50_layer3_layer4(num_keypoints, pretrained_backbone=True, deconv_with_bias=False, finetune=False, progress=True, **kwargs):
#     """Constructs a Simple Baseline model with a ResNet-101 backbone.
#
#     Args:
#         num_keypoints (int): number of keypoints
...
#
#     update_config(cfg, kwargs['args'])
#     model = get_pose_net_layer3_layer4(cfg)
#     model.finetune = finetune
#     return model, cfg
#
#
# def trans_pose_resnet50_layer3_layer4_add(num_keypoints, pretrained_backbone=True, deconv_with_bias=False, finetune=False, progress=True, **kwargs):
#     """Constructs a Simple Baseline model with a ResNet-101 backbone.
#
#     Args:
#         num_keypoints (int): number of keypoints
...
#
#     update_config(cfg, kwargs['args'])
#     model = get_pose_net_layer3_layer4_add(cfg)
#     model.finetune = finetune
#     return model, cfg